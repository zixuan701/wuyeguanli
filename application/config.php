...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '5G+|M!aW;tq6<bAh/3vRH-ro_*C0xU"pOiP.2(Z$', //默认数据加密KEY
	'data_cache_key'=> '5G+|M!aW;tq6<bAh/3vRH-ro_*C0xU"pOiP.2(Z$',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'5G+|M!aW;tq6<bAh/3vRH-ro_*C0xU"pOiP.2(Z$', //加密KEY
