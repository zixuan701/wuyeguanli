<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\WWW\tp5\public/../application/admin/view/default/repair\add.html";i:1533780240;s:77:"D:\phpStudy\WWW\tp5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('add'); ?>" method="post">
    ...
    <div class="form-item">
        <label class="item-label"><span class="check-tips">姓名</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        <label class="item-label"><span class="check-tips">地址</span></label>
        <div class="controls">
    ...
    <!--<div class="form-item">-->
        <!--<label class="item-label"><span class="check-tips">时间</span></label>-->
        <!--<div class="controls">-->
            <!--<input type="text" class="text input-large" name="time" value="">-->
        <!--</div>-->
    <!--</div>-->
    <div class="form-item">
        <label class="item-label"><span class="check-tips">内容</span></label>
        <div class="controls">
