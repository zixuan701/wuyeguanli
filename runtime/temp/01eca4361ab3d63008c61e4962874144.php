<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\WWW\tp5\public/../application/admin/view/default/zushou\add.html";i:1534045089;s:77:"D:\phpStudy\WWW\tp5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-item">
        <label class="item-label"><span class="check-tips">类型</span></label>
        <div class="controls">
            <label>出租:<input type="radio" name="type" value="1"></label>
            <label>出售:<input type="radio" name="type" value="0"></label>
        </div>
    </div>

    <div class="form-item">
        <label class="item-label"><span class="check-tips">价格</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        <label class="item-label"><span class="check-tips">电话</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        <label class="item-label"><span class="check-tips">简介</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="des" value="">
        </div>
    </div>

    <div class="form-item">
        <label class="textarea">
            <textarea name="<?php echo $field['content']; ?>"><?php echo $field['value']; ?></textarea>
    ...
    <br>
    <button class="btn submit-btn ajax-posts"  type="submit" target-form="form-horizontal">确 定</button>
</form>
