<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\WWW\tp5\public/../application/user/view/default/login\register.html";i:1533793523;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<!--验证码结束-->
            ...
            <div class="form-group">
                <button class="btn btn-primary onlineBtn">立即注册</button>
            </div>

            <div class="form-group">
                <a href="" style="float: left">忘记密码</a>
                <span style="float: right">
                    已有账号&emsp;<a href="<?php echo url('User/login'); ?>">点此登录</a>
                </span>
            </div>
        </form>
    </div>
