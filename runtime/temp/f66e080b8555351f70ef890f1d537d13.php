<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpStudy\WWW\tp5\public/../application/admin/view/default/zushou\index.html";i:1534039918;s:77:"D:\phpStudy\WWW\tp5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo !empty($zushou['type']) && $zushou['type']==1?'出租':'出售'; ?></td>
            <td><?php echo $zushou['img']; ?></td>
            <td><?php echo $zushou['price']; ?></td>
            <td><?php echo $zushou['tel']; ?></td>
            <td><?php echo $zushou['des']; ?></td>
            <td><?php echo date("Y-m-d H:i:s",$zushou['time']); ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$zushou['id']); ?>">编辑</a>
...
<div>
    <ul>
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zushou): $mod = ($i % 2 );++$i;?>
        <li> <?php echo $zushou['nickname']; ?></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
